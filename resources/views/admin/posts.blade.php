                        ...
                        <table class="table table-bordered table-striped" id="jDataTable">
                            ...
                            @foreach($posts as $post)
                                ...
                                <tr>
                                    ...
                                    <td>{!! '<a href="'.route('edit_post',$post->slug).'" class="btn btn-primary"><i class="fa fa-edit"></i> </a><a href="javascript:;" class="btn btn-danger deletePage" data-slug="'.$post->slug.'"><i class="fa fa-trash"></i> </a>' !!}</td>
                                </tr>
                            @endforeach
